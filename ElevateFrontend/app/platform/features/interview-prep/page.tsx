...
interface QuestionAnalysis {
  ...
  commonPitfalls: CommonPitfall[]; // Added
}
...
// LeetCode Patterns Explanations
...
// Behavioral Questions Explanations
...
const QuestionBreakdown = ({ analysis }: { analysis: QuestionAnalysis }) => (
  <div className="bg-white rounded-xl border border-gray-200 p-6 mb-6">
    <div className="flex items-center gap-3 mb-6">
      ...
      <h3 className="text-xl font-semibold text-gray-900">Problem Breakdown</h3>
    </div>

    <Accordion title="Step-by-Step Approach" icon="🧠" initialOpen={true}>
      <div className="space-y-4">
        {analysis.approach.map((step, index) => (
          <div key={index} className="group relative pl-8">
            ...
            <div className="p-4 bg-white border border-gray-200 rounded-lg hover:border-blue-200 transition-colors">
              ...
              {index < analysis.approach.length - 1 && (
        ...
        <div className="p-4 bg-blue-50 rounded-lg">
          <div className="flex justify-between items-center mb-2">
            ...
            <span className="px-2 py-1 bg-blue-100 text-blue-800 rounded-full text-xs">
              {analysis.complexityAnalysis.time.value}
            </span>
          </div>
          <p className="text-gray-700 text-sm mb-3">
            {analysis.complexityAnalysis.time.explanation}
          </p>
          <ComplexityProgress value={analysis.complexityAnalysis.time.value} />
        </div>
        ...
        <div className="p-4 bg-purple-50 rounded-lg">
          <div className="flex justify-between items-center mb-2">
            ...
            <span className="px-2 py-1 bg-purple-100 text-purple-800 rounded-full text-xs">
              {analysis.complexityAnalysis.space.value}
            </span>
          </div>
          <p className="text-gray-700 text-sm mb-3">
            {analysis.complexityAnalysis.space.explanation}
          </p>
          <ComplexityProgress value={analysis.complexityAnalysis.space.value} />
        </div>
        ...
        <div className="p-4 bg-green-50 rounded-lg">
          ...
          <div className="flex items-center gap-2 text-sm">
            ...
            <p className="text-gray-700">
              {analysis.complexityAnalysis.comparison}
            </p>
          </div>
        </div>
      </div>
    ...
    <Accordion title="Edge Cases & Solutions" icon="⚠️">
      <div className="space-y-4">
        {analysis.edgeCases.map((edgeCase, index) => (
      ...
      <div className="space-y-6">
        ...
        <div className="p-4 bg-blue-50 rounded-lg">
          ...
          <div className="space-y-2 text-gray-700 text-sm">
            {analysis.sampleSolution.codeExplanation
              .split("\n")
              .map((line, i) => (
    ...
    <div className="space-y-4">
      ...
      <Accordion title="STAR Method" icon="⭐">
        <div className="grid grid-cols-1 gap-4 p-2">
          ...
          >
            <div className="flex items-center gap-3 mb-2">
              <div className="w-8 h-8 bg-green-100 rounded-full flex items-center justify-center font-bold text-green-800"></div>
...
export default function InterviewPreparation() {
  ...
  const handleQuestionAnalysis = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      const res = await axios.post("http://localhost:8000/analyze_question", {
