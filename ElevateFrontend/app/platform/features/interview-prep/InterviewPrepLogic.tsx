...
export const coreTopicExplanations: { [key: string]: string } = {
  Arrays:
...
export const leetCodePatternExplanations: { [key: string]: string } = {
  "Sliding Window":
...
export const studyRoadmapExplanations: { [key: string]: string } = {
...
export const behavioralQuestionExplanations: { [key: string]: string } = {
...
export const starMethodExplanation = `The STAR method is a structured manner of responding to behavioral interview questions by discussing the:
